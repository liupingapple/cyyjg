	...
	<div class="panel panel-default">
		...
		<div class="panel-foot">
			<g:if test="${prodInstruct?.status == CONSTANT.INSTRUCT_STATUS_DRAFT }">
				<p class="text-center">
				<g:link controller="bomActual" action="prodInstConfirm" id="${bomActualObj?.id }" class="btn btn-success btn-sm" onclick="return confirm('确定生产单后，生产部门将按照生产BOM进行生产');">确定生产单</g:link>				
				...
				<div id="splitForm" style="display:none" class="text-center">
					<g:form controller="bomActual" action="prodInstSplit" id="${bomActualObj?.id }">
						拆分数量：<g:textField name="split_quantity" value=""/> 千克
