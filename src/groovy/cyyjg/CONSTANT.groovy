...
class CONSTANT {
	...
	final static INSTRUCT_STATUSes = [INSTRUCT_STATUS_DRAFT, INSTRUCT_STATUS_CONFIRMED, INSTRUCT_STATUS_PRODUCED, INSTRUCT_STATUS_DELIVERED, INSTRUCT_STATUS_DONE]
